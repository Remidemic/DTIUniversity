        ...
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>This web tool will render important expense and related data points about every acredited college / university in the united states.
                    Begin by entering a learning institution in the search bar. A list of school facts will populate. Continue down the page to see a full list of programs offered at the sinstitution. Do you see a $ next to a program? That means there is reported data from the instition about expected future earnings. <br></br><br></br> No earnings recorded? No problem! Hit the email button to reach out directly to the institution via email! Good Luck!</Modal.Body>
                <Modal.Footer>
